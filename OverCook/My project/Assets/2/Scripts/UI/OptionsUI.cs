...
public class OptionsUI : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        interactAlternateButton.onClick.AddListener(() => { RebindBinding(GameInput.Binding.InteractAlternat); });
    ...
    private void UpdateVisual()
    {
        ...
        interactAlternateText.text = GameInput.Instance.GetBindingText(GameInput.Binding.InteractAlternat);
